...
class PeriscopeApplication:
    def __init__(
        ...
        if algorithm == SolveAlgorithm.DIRECT:
            ...
            self.plane_3_process: mp.Process = mp.Process(target=DirectAlgorithm.plane_direct_process,
                            args=(self.plane_3_queue, self.plane_3_points, self.periscope, MirrorLocation.THREE))
    ...
    def run (self):
        ...
        while not exit_app:
            ...
            self.renderer.render(p1_intersect, p2_intersect, p3_intersect, p4_intersect, tee, p_aim)
